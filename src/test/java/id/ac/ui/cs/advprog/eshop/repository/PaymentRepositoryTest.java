...
class PaymentRepositoryTest {
    ...
    public void setUp() {
        ...
        product2.setProductName("Sampo Cap Bambang Baru");
        ...
        orders.add(order1);
        Order order2 = new Order("7f9e15bb-4b15-42f4-aebc-c3af385fb078", products, 1708570000L, "Safira Widjaja");
        orders.add(order2);
        Order order3 = new Order("e334ef40-9eff-4da8-9487-8ee697ecbf1e", products, 1708570000L, "Safira Nurrohmah");
        orders.add(order3);
        ...
        paymentData2.put("bankName", "OCBC");
        paymentData2.put("referenceCode", "028");
    ...
    void testFindByIdIfNotFound() {
        ...
        Payment findResult = paymentRepository.findById("wkwkwkwk");
